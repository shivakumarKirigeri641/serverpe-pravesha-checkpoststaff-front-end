...
const S = {
  en: {
    ...
    noneInside: 'No vehicle is inside right now.', noExits: 'No exits recorded yet.',
    exitHint: 'Leaving vehicle: type the last 4 digits of the number plate.',
    notEnteredChip: 'Not checked in', exitTitle: 'Check out this vehicle?',
    ...
    passDetails: 'Pass details', amountPaid: 'Amount paid', allFeesIncluded: 'Includes the entry fee, service fee and GST',
    exitedWord: 'Checked out', timeInsideWord: 'Time inside', stillInside: 'Still inside',
  ...
  kn: {
    ...
    noneInside: 'ಈಗ ಒಳಗೆ ಯಾವ ವಾಹನವೂ ಇಲ್ಲ.', noExits: 'ಇನ್ನೂ ಯಾವುದೇ ನಿರ್ಗಮನ ದಾಖಲಾಗಿಲ್ಲ.',
    exitHint: 'ಹೊರಹೋಗುವ ವಾಹನ: ನಂಬರ್ ಪ್ಲೇಟ್‌ನ ಕೊನೆಯ 4 ಅಂಕಿಗಳನ್ನು ಟೈಪ್ ಮಾಡಿ.',
    notEnteredChip: 'ಪ್ರವೇಶ ದಾಖಲಾಗಿಲ್ಲ', exitTitle: 'ಈ ವಾಹನದ ನಿರ್ಗಮನ ದಾಖಲಿಸಬೇಕೇ?',
    ...
    passDetails: 'ಪಾಸ್ ವಿವರ', amountPaid: 'ಪಾವತಿಸಿದ ಮೊತ್ತ', allFeesIncluded: 'ಪ್ರವೇಶ ಶುಲ್ಕ, ಸೇವಾ ಶುಲ್ಕ ಮತ್ತು GST ಸೇರಿದೆ',
    exitedWord: 'ನಿರ್ಗಮನ', timeInsideWord: 'ಒಳಗಿದ್ದ ಸಮಯ', stillInside: 'ಇನ್ನೂ ಒಳಗಿದ್ದಾರೆ',
